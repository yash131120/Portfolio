  ...
  return (
    <section id="projects" className="relative pb-[10%]"> {/* Added padding-bottom */}
      ...
      <div className="relative px-6 py-20">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center px-4 sm:px-8">
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div
              className={`w-full h-80 bg-gradient-to-br from-orange-100 to-pink-200 rounded-xl shadow-xl flex items-center justify-center text-4xl font-bold text-white ${
            ...
            <button
              onClick={prevProject}
              className="absolute left-[-12%] top-1/2 transform -translate-y-1/2 bg-orange-500 text-white p-4 rounded-full shadow-lg hover:bg-orange-600"
            >
              <FaArrowLeft />
            </button>
            <button
              onClick={nextProject}
              className="absolute right-[-12%] top-1/2 transform -translate-y-1/2 bg-orange-500 text-white p-4 rounded-full shadow-lg hover:bg-orange-600"
            >
              <FaArrowRight />
            </button>
          </div>
