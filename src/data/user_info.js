...
// /---------------------------------------------
{/* <section className="bg-gradient-to-b from-orange-200 to-white relative py-20 px-6 overflow-hidden">

<div className="absolute top-0 left-0 w-72 h-72 bg-orange-300 opacity-20 rounded-full blur-3xl animate-pulse"></div>
<div className="absolute bottom-0 right-0 w-96 h-96 bg-orange-400 opacity-10 rounded-full blur-2xl animate-ping"></div>
<div className="absolute bottom-0 left-0 w-96 h-96 bg-sky-400 opacity-10 rounded-full blur-2xl animate-ping"></div> */}
